                ...
                {bannerData.map((data, index) => {
                    return (
                        <div key={data.id} style={{ transform: `translateX(-${currentBanner * 100}%)` }} className='container h-[70vh] relative min-w-full overflow-hidden lg:h-full  group'>
                            ...
                            <div className='movie-poster h-[95vh] w-full md:h-[100vh] '>
                            ...
                            <div className='movie-info absolute  left-0 bottom-0 px-5 lg:mb-20 lg:w-1/2 lg:px-16'>
                                ...
                                <button className='text-xl my-5 bg-white text-black font-bold py-3 rounded-xl flex justify-center items-center gap-2 w-full  hover:scale-95 transition-all lg:w-[75%] lg:text-3xl'><FaGooglePlay />watch trailer</button>
                            </div>
